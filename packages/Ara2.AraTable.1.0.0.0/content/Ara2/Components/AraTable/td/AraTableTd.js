...
Ara.AraClass.Add('AraTableTd', function (vAppId, vId, ConteinerFather) {
    ...
    this.SetColSpan = function (vValue) {
        this.Obj.colSpan = vValue;
    }

    this.SetRowSpan = function (vValue) {
        this.Obj.rowSpan = vValue;
    }
